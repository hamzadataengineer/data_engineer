...
from binV2.transformers.ingest_air_craft import AirCraft


class RunJadoopAirCraft(BaseSubscriber):
    topic = 'air_craft_test'
...
if __name__ == '__main__':
    while True:
        try:
            run_jadoop_pipline_obj = RunJadoopAirCraft()
